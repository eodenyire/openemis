...
class OpStudent(models.Model):
    ...
    invoice_ids = fields.Many2many(
        'account.move', compute='_compute_invoices',
        string='Invoices')
    ...
    def _compute_invoices(self):
        for student in self:
            ...
            student.invoice_ids = all_invoices
            student.total_invoiced = sum(posted_invoices.mapped('amount_total'))
    ...
    def action_view_invoice(self):
        ...
        inv_ids = []
        for student in self:
            inv_ids.extend(student.invoice_ids.ids)
