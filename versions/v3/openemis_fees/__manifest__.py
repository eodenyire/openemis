...

{
    ...
    'images': [
        'static/description/openemis-fees_banner.jpg',
    ],
    'assets': {
        'web.assets_backend': [
            'openemis_fees/static/src/js/page_list.js',
            'openemis_fees/static/src/js/fees_term_widget.js',
            'openemis_fees/static/src/xml/fees_term_widget_template.xml',
        ],
    },
    'demo': [
