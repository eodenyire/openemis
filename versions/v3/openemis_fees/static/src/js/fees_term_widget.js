...
//            image: this.getImagePath(item[0]),
    ...
    get ImagePath() {
        return {
            'fixed_days': '/openemis_fees/static/description/term_type_1.svg',
            'fixed_date': '/openemis_fees/static/description/term_type_2.svg',
            'duration_based': '/openemis_fees/static/description/term_type_3.svg',
            'session_based': '/openemis_fees/static/description/term_type_4.svg',
            'faculty_based': '/openemis_fees/static/description/term_type_5.svg'
        }
    }
    onSelectValue(value) {
        this.props.record.update({ [this.props.name]: value });
