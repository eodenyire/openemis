...
class OpParent(models.Model):
    ...
    def create_parent_user(self):
        template = self.env.ref('openemis_parent.parent_template_user')
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/openemis_parent/static/xls/op_parent.xls'
        }]
...
class OpStudent(models.Model):
    ...
    def get_parent(self):
        self.ensure_one()
        action = self.env.ref('openemis_parent.act_open_op_parent_view').sudo().read()[0]
