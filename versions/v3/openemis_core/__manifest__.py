...

{
    ...
    'qweb': [
        ...
        'static/src/xml/dashboard_ext_openemis.xml'
    ],
    'js': [],
    'images': [
        'static/description/openemis_core_banner.jpg',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
    'post_init_hook': '_openemis_post_init',
    'assets': {
        'website.assets_frontend': [
            '/openemis_core/static/src/scss/main.scss',
        ],
        'web.assets_backend': [
            '/openemis_core/static/src/scss/style.scss',
            '/openemis_core/static/src/js/g2_review.js',
            '/openemis_core/static/src/js/field_inline_char.js',
            '/openemis_core/static/src/js/inline_many2one.js',
            '/openemis_core/static/src/xml/review.xml',
            '/openemis_core/static/src/xml/web_client.xml',
        ],
    },
}
